...
public class ColoredTextView extends AppCompatTextView {
    ...
    private static final int CORNER_RADIUS = (int) PxUtils.dp2px(4);
    private static final int X_PADDING = (int) PxUtils.dp2px(16);
    private static final int Y_PADDING = (int) PxUtils.dp2px(8);
